> **2026-09-05执行范围更新**：已定FXR/GNN/CW-BCS主稿进入有条件投稿准备，真实导师未签核。当前安排见[审批与五人方案](中文核心投稿审批与五人执行方案.md)和[研究问题协议](研究问题协议_G0.md)。下面保留的V2诊断与FASN修复顺序不作为V1投稿必经路线；只有实际引用的分支才验收对应证据。
